...
export const angryfoodlist = [
    { src: '/images/pattern/mukkitlist/menu/단호박.png', name: '단호박' },
    { src: '/images/pattern/mukkitlist/menu/초콜릿.png', name: '다크초콜릿' },
    { src: '/images/pattern/mukkitlist/menu/견과류.png', name: '견과류' },
    { src: '/images/pattern/mukkitlist/menu/고구마.png', name: '고구마' },
    { src: '/images/pattern/mukkitlist/menu/고추.png', name: '고추' },
    { src: '/images/pattern/mukkitlist/menu/사과.png', name: '사과' },
    { src: '/images/pattern/mukkitlist/menu/연어.png', name: '연어' },
